<template>
	<view class="home">
		...
		<AudioVisualFrom v-model="model"></AudioVisualFrom>
...
<script>
	...
	import AudioVisualFrom from '@/components/investigation/AudioVisualFrom.vue'
		...
		methods: {
			async getlist(getrotuer) {
				try {
					...
					const res = await this.api.fieldInvestigation.audioVisualqueryById(option)
