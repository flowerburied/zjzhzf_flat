<template>
	<view class="home">
		...
		<InspectionFrom v-model="model"></InspectionFrom>
...
<script>
	...
	import InspectionFrom from '@/components/investigation/InspectionFrom.vue'
		...
		methods: {
			async getlist(getrotuer) {
				try {
					...
					const res = await this.api.fieldInvestigation.inspectionqueryById(option)
